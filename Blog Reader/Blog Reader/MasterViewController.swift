            ...
            if error != nil {
                ...
                if jsonResult.count > 0 {
                    ...
                    if let items = jsonResult["items"] as? NSArray{
                        ...
                        // DELETING prev records which are all stored in DB
                        ...
                        for item in items{
                            ...
                            if let title = item["title"] as? String{
                                ...
                                if let content = item["content"] as? String{
                                    ...
                                    var newObject:NSManagedObject = NSEntityDescription.insertNewObjectForEntityForName("Posts", inManagedObjectContext: context!) as! NSManagedObject
